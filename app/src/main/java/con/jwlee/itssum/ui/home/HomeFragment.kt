...
/*            var bundle = Bundle()
            ...
            (activity as MainActivity).removeFragment(HomeFragment.newInstance())
            (activity as MainActivity).replaceFragment(MarketListFragment.newInstance(), bundle,"MarketListFragment")*/
        }
